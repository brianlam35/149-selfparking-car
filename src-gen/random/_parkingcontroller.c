...
#include "include/random/ParkingController.h"
...
void _parkingcontrollerreaction_function_0(void* instance_args) {
    ...
    #line 73 "/home/lambrian/149-selfparking-car/src/random.lf"
...
#line 24 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
...
void _parkingcontrollerreaction_function_1(void* instance_args) {
    ...
    _parkingcontroller_notify_t* notify = &self->_lf_notify;
    _parkingcontroller_state_display_t* state_display = &self->_lf_state_display;
    #line 82 "/home/lambrian/149-selfparking-car/src/random.lf"
    lf_set(calibrate, false);
    lf_set(notify, "READY");
    lf_set(state_display, "WAIT");
    printf("Ready - waiting for target\n");
#line 38 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_2(void* instance_args) {
    ...
    _parkingcontroller_notify_t* notify = &self->_lf_notify;
    _parkingcontroller_state_display_t* state_display = &self->_lf_state_display;
    #line 93 "/home/lambrian/149-selfparking-car/src/random.lf"
...
#line 82 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_3(void* instance_args) {
    ...
    #line 127 "/home/lambrian/149-selfparking-car/src/random.lf"
...
#line 148 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_4(void* instance_args) {
    ...
    #line 188 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
    ...
    self->last_left_high = left_high;
#line 212 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_5(void* instance_args) {
    ...
    #line 251 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
    ...
    self->last_left_high = left_high;
#line 276 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_6(void* instance_args) {
    ...
    #line 309 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
...
#line 330 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_7(void* instance_args) {
    ...
    #line 354 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
...
#line 372 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_8(void* instance_args) {
    ...
    #line 395 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
...
#line 460 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_9(void* instance_args) {
    ...
    reactor_mode_t* TURN_RIGHT_INTO_SPOT = &self->_lf__modes[9];
    lf_mode_change_type_t _lf_TURN_RIGHT_INTO_SPOT_change_type = reset_transition;
    #line 480 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
    ...
    self->last_left_high = left_high;
    self->last_right_high = right_high;
#line 550 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_10(void* instance_args) {
    ...
    #line 561 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
...
#line 591 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_11(void* instance_args) {
    ...
    reactor_mode_t* PARK_FORWARD = &self->_lf__modes[10];
    lf_mode_change_type_t _lf_PARK_FORWARD_change_type = reset_transition;
    #line 595 "/home/lambrian/149-selfparking-car/src/random.lf"
    int R4 = reflect->value[4];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
...
#line 632 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_12(void* instance_args) {
    ...
    reactor_mode_t* PARKED = &self->_lf__modes[11];
    lf_mode_change_type_t _lf_PARKED_change_type = reset_transition;
    #line 630 "/home/lambrian/149-selfparking-car/src/random.lf"
    int L0 = reflect->value[0];
    int CL = reflect->value[1];
    int C  = reflect->value[2];
    int CR = reflect->value[3];
...
#line 692 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _parkingcontrollerreaction_function_13(void* instance_args) {
    ...
    int target_spot_width = self->_lf_target_spot_width; SUPPRESS_UNUSED_WARNING(target_spot_width);
    _parkingcontroller_notify_t* notify = &self->_lf_notify;
    #line 683 "/home/lambrian/149-selfparking-car/src/random.lf"
    // Could handle exit here later
    printf("Already parked. Exit not implemented.\n");
#line 704 "/home/lambrian/149-selfparking-car/src-gen/random/_parkingcontroller.c"
}
#include "include/api/reaction_macros_undef.h"
